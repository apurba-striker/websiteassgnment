...
import feature1 from "../assets/images/ph1.png";
...
export const Features1 = () => {
  ...
  return (
    <section
      ...
      id="features"
    >
     <div className="text-center pt-6 pb-20  text-4xl font-bold">Discover your new superpowers</div>
      <motion.div
        initial={{ opacity: 0 }}
        ...
        <div className="flex flex-wrap items-center 2xl:w-[1450px] xl:w-[1300px] w-11/12 mx-auto md:pl-4 xl:pr-16 xl:pl-16 ">
          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            ...
            <div data-aos="fade-right">
              <span className=" text-2xl font-medium border  rounded-full px-5 bg-yellow-200">Seamless Scheduling</span>
