...
export const Pricing = () => {
  ...
  return (
    <section className="w-screen flex justify-center bg-[#fef9f6] relative">
    
      <div className="absolute -top-16" id="pricing" />
      <div className="pb-20 pt-12 bg-[#fef9f6]  2xl:w-[1150px] lg:w-[1050px]  md:w-4/5 ">
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <div className="text-center pt-2 pb-7  text-4xl font-bold">Find the best plan for your needs</div>
